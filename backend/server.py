...
async def seed_data():
    ...
    # Payment links
    public_url = os.environ.get("PUBLIC_BASE_URL", "https://hospitality-ops-4.preview.emergentagent.com")
    payment_links_seed = [
    ...
    await db.connector_credentials.update_one(
        ...
        {"$set": {
            ...
            "oauth_redirect_uri": f"https://hospitality-ops-4.preview.emergentagent.com/api/v2/integrations/meta/oauth/callback",
            "access_token": "",
