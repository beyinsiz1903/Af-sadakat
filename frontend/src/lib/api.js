...
export const guestAPI = {
  ...
  checkAvailability: (slug, params) => api.get(`/v2/guest-services/g/${slug}/rooms/availability`, { params }),
  createGuestReservation: (slug, data) => api.post(`/v2/guest-services/g/${slug}/rooms/reserve`, data),
...
export const guestServicesAPI = {
  ...
  getRoomFolio: (slug, code) => api.get(`/v2/guest-services/g/${slug}/room/${code}/folio`),
  getVapidKey: (slug) => api.get(`/v2/guest-services/g/${slug}/push/vapid-key`),
  pushSubscribe: (slug, code, data) => api.post(`/v2/guest-services/g/${slug}/room/${code}/push/subscribe`, data),
  pushUnsubscribe: (slug, code, data) => api.delete(`/v2/guest-services/g/${slug}/room/${code}/push/unsubscribe`, { data }),
  getPushPreferences: (slug, code, endpoint) => api.get(`/v2/guest-services/g/${slug}/room/${code}/push/preferences`, { params: { endpoint } }),
  updatePushPreferences: (slug, code, data) => api.put(`/v2/guest-services/g/${slug}/room/${code}/push/preferences`, data),
